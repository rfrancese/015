...
public class InserisciCommentoDipendente extends AsyncTask<String, String, String> {

	private static GestioneCommentiDipendente home;
	
	public InserisciCommentoDipendente(GestioneCommentiDipendente home)
	{
		this.home=home;
	}
	...
	protected String doInBackground(String... uri) {
		...
		try {
			...
			nameValuePairs.add(new BasicNameValuePair("Testo", uri[3]));
	...
	public void onPostExecute(String result)
	{
		...
		home.inserimentoEffettuato(result);
	}
