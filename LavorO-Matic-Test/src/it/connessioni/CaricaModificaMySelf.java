...
import applicaton.lavoro_matic_test.ModificaImpostazioni;

public class CaricaModificaMySelf extends AsyncTask<String, String, String> {
	private static ModificaImpostazioni home;
	
	public CaricaModificaMySelf(ModificaImpostazioni h)
	{
		home=h;
	}
